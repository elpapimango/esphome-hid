...
#if defined(USE_LIGHT) && defined(USE_ESP32) && defined(USE_HID_COMPOSITE_LAMP_ARRAY)
...
static const char *const TAG = "hid_composite.effect";
...
void LampArrayLightEffect::start() {
  ...
  this->buffer_.assign(this->lamp_array_->lamp_count(), lamp_array_core::LampColor{0, 0, 0, 0});
...
#endif  // USE_LIGHT && USE_ESP32 && USE_HID_COMPOSITE_LAMP_ARRAY
